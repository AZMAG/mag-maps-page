    ...
    grunt.initConfig({
        ...
        htmlmin: {
            htmlmin1: {
                ...
                files: {
                    ...
                    "dist/trainings/index.html": "dist/trainings/index.html"
                }
            },
            htmlmin2: {
                options: {
        ...
        toggleComments: {
            customOptions: {
                ...
                files: {
                    ...
                    "dist/trainings/index.html": "src/trainings/index.html",
        ...
        replace: {
            update_Meta: {
                // source files array
                // RegExp Expression
                src: ["src/index.html", "src/trainings/index.html", "src/releaseHistory.html", "src/js/main.js", "src/humans.txt", "README.md", "LICENSE", "src/LICENSE"],
