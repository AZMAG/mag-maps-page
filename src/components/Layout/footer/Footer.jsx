...
// import LegalDisclaimerModal from "../../Modals/legalDisclaimer/LegalDisclaimerModal";

export default function Footer() {
    return (
        <footer
            tag="footer"
            className="mt-auto flex-col flex-wrap items-center justify-center space-x-6 bg-slate-200 text-center text-slate-700"
        >
            ...
            <section className="container mx-auto my-11 flex flex-row justify-center text-center text-xs">
                ...
                <ul className="flex list-none justify-center divide-x divide-stone-700 md:order-2">
                    <li className="px-2">{DocConfig.version}</li>
                    <li className="px-2">{DocConfig.date}</li>
                    <li className="px-2 text-gray-700 hover:underline">
                        {/* <PrivacyModal /> */}
                    </li>
                    <li className="px-2 text-gray-700 hover:underline">
                        {/* <TermsModal /> */}
