...
export default function TrainingInfo() {
  ...
  return (
    <section tag="training-info" className="bg-slate-100">
      <section className="mx-auto grid max-w-screen-xl px-4 py-8 lg:grid-cols-12 lg:gap-8 lg:py-16 xl:gap-0">
        <div className="mr-auto place-self-center lg:col-span-7">
          <h3 className="mb-4 text-3xl font-bold leading-none tracking-tight text-slate-800">
            MAG Maps & Data Workshops
          </h3>
          <p className="mb-3 text-lg text-slate-800">
        ...
        <div className="items-center justify-center lg:col-span-5 lg:mt-0 lg:flex">
          <img src={Training1} className="h-60" alt="heat-relief-logo" />
        </div>
      </section>
      <section className="mx-auto grid max-w-screen-xl px-4 py-8 lg:grid-cols-12 lg:gap-8 lg:py-16 xl:gap-0">
        <div className="items-center justify-center lg:col-span-5 lg:mt-0 lg:flex">
          <img src={Training2} className="h-60" alt="heat-relief-logo" />
        </div>
        <div className="mr-auto place-self-center lg:col-span-7">
          <h3 className="mb-4 text-3xl font-bold leading-none tracking-tight text-slate-800">
          ...
          <ul className="ml-6 text-lg text-slate-800">
      ...
      <section className="mx-auto grid max-w-screen-xl px-4 py-8 lg:grid-cols-12 lg:gap-8 lg:py-16 xl:gap-0">
        <div className="mr-auto place-self-center lg:col-span-7">
          ...
          <div className="my-6 flex flex-row justify-center">
            <div className="bg-primary-700 hover:bg-primary-800 focus:ring-primary-300 mr-3 inline-flex items-center justify-center rounded-lg px-5 py-3 text-center text-base font-medium text-slate-800">
              Get started
              <svg
        ...
        <div className="items-center justify-center lg:col-span-5 lg:mt-0 lg:flex">
          <img src={Training3} className="h-60" alt="heat-relief-logo" />
        </div>
      </section>
      <section className="mx-auto grid max-w-screen-xl px-4 py-8 lg:grid-cols-12 lg:gap-8 lg:py-16 xl:gap-0">
        <div className="items-center justify-center lg:col-span-5 lg:mt-0 lg:flex">
          <img src={Training4} className="h-60" alt="heat-relief-logo" />
        </div>
        <div className="mr-auto place-self-center lg:col-span-7">
          <h3 className="mb-4 text-3xl font-bold leading-none tracking-tight text-slate-800">
      ...
      <section className="mx-auto grid max-w-screen-xl px-4 py-8 lg:grid-cols-12 lg:gap-8 lg:py-16 xl:gap-0">
        ...
        <div className="items-center justify-center lg:col-span-5 lg:mt-0 lg:flex">
          <img src={Training5} className="h-60" alt="heat-relief-logo" />
        </div>
      </section>
      <section className="mx-auto grid max-w-screen-xl px-4 py-8 lg:grid-cols-12 lg:gap-8 lg:py-16 xl:gap-0">
        <div className="items-center justify-center lg:col-span-5 lg:mt-0 lg:flex">
