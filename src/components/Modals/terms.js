    ...
    <span>
      ...
      <Modal size="lg" show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          ...
          <p>
            The MAG Mapping Center Web Site is comprised of various Web pages
            operated by MAG Mapping Center. The MAG Mapping Center Web Site is
            ...
            the MAG Mapping Center Web Site constitutes your agreement to all
          ...
          <p>
            ...
            conditions, and notices under which the MAG Mapping Center Web Site
            is offered, including but not limited to the charges associated with
            the use of the MAG Mapping Center Web Site.
          </p>
          <h4>Links to Third Party Sites</h4>
          <p>
            The MAG Mapping Center Web Site may contain links to other Web Sites
            ("Linked Sites"). The Linked Sites are not under the control of MAG
            Mapping Center and MAG Mapping Center is not responsible for the
            ...
            Site. MAG Mapping Center is not responsible for webcasting or any
            other form of transmission received from any Linked Site. MAG
            Mapping Center is providing these links to you only as a
            convenience, and the inclusion of any link does not imply
            endorsement by MAG Mapping Center of the site or any association
            with its operators.
          </p>
          <h4>No Unlawful or Prohibited Use</h4>
          <p>
            As a condition of your use of the MAG Mapping Center Web Site, you
            warrant to MAG Mapping Center that you will not use the MAG Mapping
            Center Web Site for any purpose that is unlawful or prohibited by
            these terms, conditions, and notices. You may not use the MAG
            Mapping Center Web Site in any manner which could damage, disable,
            overburden, or impair the MAG Mapping Center Web Site or interfere
            with any other party's use and enjoyment of the MAG Mapping Center
          ...
          <p>
            The MAG Mapping Center Web Site may contain bulletin board services,
            ...
            to enable you to communicate with the public at large or with a
          ...
          <p>
            MAG Mapping Center has no obligation to monitor the Communication
            Services. However, MAG Mapping Center reserves the right to review
            materials posted to a Communication Service and to remove any
            materials in its sole discretion. MAG Mapping Center reserves the
          ...
          <p>
            MAG Mapping Center reserves the right at all times to disclose any
            ...
            to remove any information or materials, in whole or in part, in MAG
          ...
          <p>
            ...
            Service. MAG Mapping Center does not control or endorse the content,
            messages or information found in any Communication Service and,
            therefore, MAG Mapping Center specifically disclaims any liability
            with regard to the Communication Services and any actions resulting
            from your participation in any Communication Service. Managers and
            hosts are not authorized MAG Mapping Center spokespersons, and their
            views do not necessarily reflect those of MAG Mapping Center.
          </p>
          <p>
          ...
          <p>
            ...
            or submitting your Submission you are granting MAG Mapping Center,
            its affiliated companies and necessary sublicensees permission to
          ...
          <p>
            ...
            TO THE INFORMATION HEREIN. MAG MAPPING CENTER AND/OR ITS SUPPLIERS
            MAY MAKE IMPROVEMENTS AND/OR CHANGES IN THE MAG MAPPING CENTER WEB
            SITE AT ANY TIME. ADVICE RECEIVED VIA THE MAG MAPPING CENTER WEB
          ...
          <p>
            ...
            RELATED GRAPHICS CONTAINED ON THE MAG MAPPING CENTER WEB SITE FOR
            ...
            ARE PROVIDED "AS IS" WITHOUT WARRANTY OR CONDITION OF ANY KIND. MAG
            MAPPING CENTER AND/OR ITS SUPPLIERS HEREBY DISCLAIM ALL WARRANTIES
          ...
          <p>
            ...
            MAG MAPPING CENTER AND/OR ITS SUPPLIERS BE LIABLE FOR ANY DIRECT,
            ...
            WITH THE USE OR PERFORMANCE OF THE MAG MAPPING CENTER WEB SITE, WITH
            THE DELAY OR INABILITY TO USE THE MAG MAPPING CENTER WEB SITE OR
            ...
            GRAPHICS OBTAINED THROUGH THE MAG MAPPING CENTER WEB SITE, OR
            OTHERWISE ARISING OUT OF THE USE OF THE MAG MAPPING CENTER WEB SITE,
            WHETHER BASED ON CONTRACT, TORT, NEGLIGENCE, STRICT LIABILITY OR
            OTHERWISE, EVEN IF MAG MAPPING CENTER OR ANY OF ITS SUPPLIERS HAS
            ...
            PORTION OF THE MAG MAPPING CENTER WEB SITE, OR WITH ANY OF THESE
          ...
          <p>
            ...
            terminate your access to the MAG Mapping Center Web Site and the
            ...
            governed by the laws of the State of Washington, U.S.A. and you
            hereby consent to the exclusive jurisdiction and venue of courts in
            San Mateo County, California, U.S.A. in all disputes arising out of
            or relating to the use of the MAG Mapping Center Web Site. Use of
            the MAG Mapping Center Web Site is unauthorized in any jurisdiction
            that does not give effect to all provisions of these terms and
            conditions, including without limitation this paragraph. You agree
            that no joint venture, partnership, employment, or agency
            relationship exists between you and MAG Mapping Center as a result
            of this agreement or use of the MAG Mapping Center Web Site. MAG
            Mapping Center's performance of this agreement is subject to
            existing laws and legal process, and nothing contained in this
            agreement is in derogation of MAG Mapping Center's right to comply
            with governmental, court and law enforcement requests or
            requirements relating to your use of the MAG Mapping Center Web Site
            or information provided to or gathered by MAG Mapping Center with
            ...
            constitutes the entire agreement between the user and MAG Mapping
            Center with respect to the MAG Mapping Center Web Site and it
            ...
            MAG Mapping Center with respect to the MAG Mapping Center Web Site.
            ...
            all related documents are drawn up in English.
          </p>
