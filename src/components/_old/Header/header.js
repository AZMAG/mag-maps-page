    ...
    <Navbar collapseOnSelect expand="lg" bg="light">
      <Container>
        <Navbar.Brand href="https://www.azmag.gov/">
          <img className="img-responsive" src="images/logos/MAG-logo.png" alt="MAG Logo" />
        </Navbar.Brand>
        ...
        <Navbar.Collapse id="basic-navbar-nav" className="magNavbar">
          <Nav>
            ...
            <Nav.Link href="https://geodata-azmag.opendata.arcgis.com/">Open Data</Nav.Link>
            <Nav.Link href="https://www.azmag.gov/About-Us/About-MAG">About</Nav.Link>
            {/* <ShareBox /> */}
