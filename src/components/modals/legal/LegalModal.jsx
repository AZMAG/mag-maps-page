  ...
  return (
    <>
      <button
        ...
        className="text-xs text-cyan-800 hover:text-cyan-800/75 hover:underline cursor-pointer"
        type="button"
            ...
            <div className="relative mx-auto my-6 w-auto max-w-3xl">
              ...
              <div className="relative flex w-full flex-col rounded-lg border-0 bg-white shadow-lg outline-none focus:outline-none">
                ...
                <div className="flex items-center gap-x-2 rounded-t border-b border-solid border-cyan-900 bg-cyan-800 p-4">
                  <FontAwesomeIcon className="text-slate-100" size="2x" icon={faBalanceScale} />
                  <h3 className="text-3xl font-semibold text-slate-100">Legal Disclaimer</h3>
                  <button
