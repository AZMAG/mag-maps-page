import ArizonaDemographics from "../../assets/images/card-icons/icon-arizona-demographics.png";
import ArizonaEmployer from "../../assets/images/card-icons/icon-arizona-employer.png";
import HeatReliefLogo from "../../assets/images/card-icons/icon-heat-relief-network.png";
import ReadOnMapLIT from "../../assets/images/card-icons/icon-readon-maplit.png";
import ReadOnSchools from "../../assets/images/card-icons/icon-readon-schools-data-center.png";
import Recreation from "../../assets/images/card-icons/icon-recreation.png";
import Bikeways from "../../assets/images/card-icons/icon-bikeways.png";
import LandUseExplorer from "../../assets/images/card-icons/icon-landuse-explorer.png";
import Projections from "../../assets/images/card-icons/icon-projections.png";
import Luke56FW from "../../assets/images/card-icons/icon-luke-56fw.png";
import ATP from "../../assets/images/card-icons/icon-atp.png";
import TIP from "../../assets/images/card-icons/icon-tip.png";
import Urban from "../../assets/images/card-icons/icon-urban.png";
import SunCloud from "../../assets/images/card-icons/suncloud.png";
import Prop479 from "../../assets/images/card-icons/icon-prop479.png";
  ...
  const cardInfo = [
    ...
    },
    {
    ...
    },
     {
      ...
      viewer: "Prop 479",
      icon: Prop479,
      link: "https://geo.azmag.gov/maps/transportation/prop479/",
      text: "Prop 479 is the continuation of an existing, dedicated half-cent sales tax in Maricopa County to fund transportation.",
      tags: ["regional", "data", "transportation", "proposition 479"],
      type: "regional",
    },
    {
      sort: 7,
    ...
    },
    {
      sort: 15,
      active: true,
      viewer: "Sun Cloud Arizona",
      icon: SunCloud,
      link: "https://arizona-sun-cloud-agic.hub.arcgis.com/",
      text: "A repository for transportation and socioeconomic datasets for the Sun Corridor region.",
      tags: ["regional", "data", "transportation", "socioeconomic"],
      type: "regional",
    },
